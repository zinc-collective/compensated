...
module Compensated
  module AppleIap
    class EventParser < Compensated::EventParser
      SUPPORTED_TYPES = %w[CANCEL DID_CHANGE_RENEWAL_PREF DID_FAIL_TO_RENEW DID_RECOVER INTERACTIVE_RENEWAL RENEWAL INITIAL_BUY DID_CHANGE_RENEWAL_STATUS].freeze
      def parses?(request)
